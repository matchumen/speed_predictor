...
if __name__ == '__main__':
    ...
    train_dfs = utils.load_preprocess_drives(train_drives, drop_null_cols=True, blur_loc_features=False, add_stop_feature=True)
    val_dfs = utils.load_preprocess_drives(val_drives, drop_null_cols=True, blur_loc_features=False, add_stop_feature=True)
    ...
    study_name = 'study_single_l1loss_sigmoid_small_stops'
    db_pth = '../00.db'
